...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest time-line-of-me.client -- --template=react`.
- Создание файла проекта (`time-line-of-me.client.esproj`).
